...
const getSocket = () => {
  if (!socket) {
    const endpoint ="https://video-call-server-kpp3.onrender.com"// "http://localhost:5000"; //"https://video-call-server-kpp3.onrender.com" //"http://localhost:5000"  //"https://video-call-server-kpp3.onrender.com" //"http://localhost:5000" //"https://video-call-server-kpp3.onrender.com";
